...
1. **cv-01 — Three-Column Professional** (profile layout)
2. **cv-02 — Navy Management** (sidebar layout)
3. **cv-03 — Classic Finance** (classic layout)
4. **cv-04 — Marketing Timeline** (timeline layout)
5. **cv-05 — Teal IT Manager** (sidebar layout)
6. **cv-06 — Bold Executive** (sidebar layout)
7. **cv-07 — Clean Green Designer** (profile layout)
8. **cv-08 — Royal Blue Technical** (sidebar layout)
9. **cv-09 — Charcoal Professional** (sidebar layout)
10. **cv-10 — Yellow Creative** (profile layout)
11. **cv-11 — Rose Minimal** (compact layout)
12. **cv-12 — Elegant Marketing** (classic layout)
13. **cv-13 — Yellow Infographic** (infographic layout)
14. **cv-14 — Black Portrait** (sidebar layout)
...
23. **cv-23 — Professional Teal** (professional layout)
24. **cv-24 — Professional Navy** (professional layout)
...
33. **cv-33 — Ink Divider** (simple, no-photo layout)
34. **cv-34 — Cyan Boxes** (simple, no-photo layout)
...
1. Open a CV in Chrome, Edge, or another modern browser.
2. Choose **Print** and select **Save as PDF**.
3. Use paper size **A4**, scale **100%**, and **no browser margins**.
4. Enable **background graphics** and disable browser headers and footers.

All pages are fixed at 210 mm × 297 mm and include print-color preservation rules. Photo-led layouts use the verified `student picture.jpg` image supplied in the project folder.
